...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "TicketBackend": () => (/* binding */ TicketBackend)
/* harmony export */ });
...
class TicketBackend {
  ...
  async newTicket({
    ...
    await randomWait();
    if (!description) throw new Error("Ticket can only be created with a valid description");
    const newTicket = {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _reach_router__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @reach/router */ "./node_modules/@gatsbyjs/reach-router/es/index.js");
/* harmony import */ var _components_layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/layout */ "./src/components/layout.js");
/* harmony import */ var _modules_ticket__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/ticket */ "./src/pages/modules/ticket.js");
...
const Router = () => {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_1__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_reach_router__WEBPACK_IMPORTED_MODULE_0__.Router, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_3__.createElement(_modules_ticket__WEBPACK_IMPORTED_MODULE_2__["default"], {
    path: "/app/ticket/:id"
  })));
};
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ticket_backend__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../ticket-backend */ "./src/ticket-backend.ts");
...
/* harmony import */ var _components_layout_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../components/layout.css */ "./src/components/layout.css");
/* harmony import */ var _components_layout_css__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_components_layout_css__WEBPACK_IMPORTED_MODULE_3__);
...
const Ticket = () => {
  const {
    id
  } = (0,_reach_router__WEBPACK_IMPORTED_MODULE_0__.useParams)();
  const [currTicket, setCurrTicket] = react__WEBPACK_IMPORTED_MODULE_1___default().useState({});
  const [error, setError] = react__WEBPACK_IMPORTED_MODULE_1___default().useState("");
  const [loading, setLoading] = react__WEBPACK_IMPORTED_MODULE_1___default().useState(false);
  react__WEBPACK_IMPORTED_MODULE_1___default().useEffect(() => {
    const req = new _ticket_backend__WEBPACK_IMPORTED_MODULE_2__.TicketBackend();

    const getData = async () => {
      setLoading(true);
      await Promise.resolve(req.ticket(Number(id))).then(async data => {
        setCurrTicket(prev => {
          return { ...prev,
            ...data
          };
        });
      }).catch(e => setError(e.message || "something gone wrong")).finally(() => {
        setLoading(false);
      });
    };
  ...
  if (loading) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement((react_spinners_ClipLoader__WEBPACK_IMPORTED_MODULE_5___default()), {
      color: "#ffffff",
      css: override,
      loading: loading,
      size: 150
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: `${completed ? "done" : "danger"} curr__tick`
  }, description);
};
...
var react_1 = __webpack_require__(/*! @emotion/react */ "./node_modules/@emotion/react/dist/emotion-react.esm.js");
